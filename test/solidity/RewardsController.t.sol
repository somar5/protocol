...
contract RewardsControllerTest is Test {
  ...
  function testAccrueRewardsForWholeDistributionPeriod() external {
    ...
    assertApproxEqAbs(distributedRewards, 600 ether, 11e18);
    assertApproxEqAbs(lastUndistributed, 1_400 ether, 11e18);
  }
  ...
  function testSetNewTargetDebtWithClaimOnlyAtEnd() external {
    ...
    vm.warp(12 weeks);
    rewardsController.claimAll(address(this));
    assertApproxEqAbs(opRewardAsset.balanceOf(address(this)), 1788 ether, 16e18);
  }
  ...
  function testSetTargetDebtMultipleTimes() external {
    ...
    vm.warp(45 weeks);
    rewardsController.claimAll(address(this));
    assertApproxEqAbs(opRewardAsset.balanceOf(address(this)), 1952 ether, 15e17);
  }
  ...
  function testSetTargetDebtMultipleTimesAfterEnd() external {
    ...
    vm.warp(45 weeks);
    rewardsController.claimAll(address(this));
    assertApproxEqAbs(opRewardAsset.balanceOf(address(this)), 1900 ether, 77e17);
  }
